-- code to create type for enummerated values of account types
...
CREATE TABLE IF NOT EXISTS public.message (
    ...
    CONSTRAINT fk_message_read FOREIGN KEY (message_to) REFERENCES public.account (account_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION,
    CONSTRAINT fk_message_from FOREIGN KEY (message_from) REFERENCES public.account (account_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION
);
